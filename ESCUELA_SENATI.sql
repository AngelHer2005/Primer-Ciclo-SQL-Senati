...
--DESEO AGREGAR UN CAMPO DESCRIPCIÓN
ALTER TABLE ALUMNO
...
--CREAR UNA RESTRICCIÓN UNIQUE AL CAMPO NOMBRE CURSO DE LA TB CURSO
GO
ALTER TABLE CURSO
ADD CONSTRAINT U_NOM_CURSO_CURSO
UNIQUE(NOMBRECUR)

--ASIGNAR UN VALOR POR DEFECTO AL CAMPO FECHA INSCRIPCIÓN DE LA TB ALUMNOS
GO
ALTER TABLE ALUMNO
